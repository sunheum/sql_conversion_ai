def prompt_trans_system():
    prompt = """
        당신은 SQL 전문가이며, Oracle SQL을 PostgreSQL(버전 15)로 변환하는 역할을 맡고 있습니다.
        주어진 Oracle SQL을 PostgreSQL로 정확하게 변환하세요. 변환할 내용이 없다면 입력 데이터를 그대로 출력하세요.
